...
sudo /bin/ln -s /etc/init.d/aeproxyd /etc/rc0.d/K99aeproxyd
sudo /bin/ln -s /etc/init.d/aeproxyd /etc/rc1.d/K99aeproxyd
sudo /bin/ln -s /etc/init.d/aeproxyd /etc/rc2.d/S99aeproxyd
sudo /bin/ln -s /etc/init.d/aeproxyd /etc/rc3.d/S99aeproxyd
sudo /bin/ln -s /etc/init.d/aeproxyd /etc/rc4.d/S99aeproxyd
sudo /bin/ln -s /etc/init.d/aeproxyd /etc/rc5.d/S99aeproxyd
sudo /bin/ln -s /etc/init.d/aeproxyd /etc/rc6.d/K99aeproxyd
